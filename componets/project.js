    ...
    const dataProject = [
        {
            ...
            textPresen: `Solución web en conjunto con DESE estudio, página web desarrollada react.js que integra la API de Google OAuth, con un backend desarrollador en node.js que integra la API de Google calendar y WhatsApp API.`
        },
        {
            name: 'MindfulMind',
            type: 'APLICACION MULTIPLATAFORMA',
