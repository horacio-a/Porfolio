                    ...
                    <div className="lineaMenuScroll">
                        <div className={`menuMain ${headerState ? 'active' : ''}`}>
                            ...
                            <div className={`nav ${headerState ? 'active ' : ''}`}>
                                <div className="Link">
                                    <div onClick={() => { ScrolltoProyect() }} className='textLink'>My projects</div>
                                </div>
                                <div className="Link">
                                    <div onClick={() => { Scrolltohabilidades() }} className='textLink'>My skills</div>
                                </div>
                                <div className="Link">
                                    <div className='textLink' onClick={() => { ScrolltoContacto() }}>Contact me at</div>
                                </div>
                                <div className='dualLink'>
                                    <Link href={'/en'} className='textLink'>Cambiar al español</Link>
                                    <Link href={'/estilos/main'} className='textLink'>I don't like the portfolio</Link>
                                </div>
                            </div>
                        </div>
